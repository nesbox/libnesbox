...
#if BUILD_YM2612
extern "C" int YM2612Init(int num, int baseclock, int rate,
               FM_TIMERHANDLER TimerHandler,FM_IRQHANDLER IRQHandler);
extern "C" void YM2612Shutdown(void);
extern "C" void YM2612ResetChip(int num);
extern "C" void YM2612UpdateOne(int num, INT16 *buffer, unsigned int length,
		     unsigned int volume);

extern "C" int YM2612Write(int n, int a,unsigned char v);
extern "C" unsigned char YM2612Read(int n,int a);
int YM2612TimerOver(int n, int c );

extern "C" void YM2612_dump(int num, uint8_t buf[512]);
extern "C" void YM2612_restore(int num, uint8_t buf[512]);
#endif /* BUILD_YM2612 */
