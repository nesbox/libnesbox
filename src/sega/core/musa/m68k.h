...
extern "C" int m68k_execute(int num_cycles);
 ...
 */
extern "C" int m68k_cycles_run(void);              /* Number of cycles run so far */
...
extern "C" unsigned int m68k_context_size(void);

/* Get a cpu context */
extern "C" unsigned int m68k_get_context(void* dst);

/* set the current cpu context */
extern "C" void m68k_set_context(void* dst);
 ...
 */
extern "C" unsigned int m68k_get_reg(void* context, m68k_register_t reg);

/* Poke values into the internals of the currently running CPU context */
extern "C" void m68k_set_reg(m68k_register_t reg, unsigned int value);
