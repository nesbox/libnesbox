 ...
 * define some or all of the following:  NAME_MAX, MAX_PATH, _POSIX_NAME_MAX,
 * _POSIX_MAX_PATH.
 */
#ifdef DOS_OS2
#  include <limits.h>
...
#  else
#    if FILENAME_MAX > 255         /* used like MAX_PATH on some systems */
#      define MAX_PATH    FILENAME_MAX
#    else
#      define MAX_PATH    (FILNAMSIZ - 1)
#    endif
#  endif /* ?MAXPATHLEN */
#endif /* !MAX_PATH */
