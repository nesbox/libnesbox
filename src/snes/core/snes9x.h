...
#define STREAM BUFFER_FILE *
#define READ_STREAM(p,l,s) buffer_file_read (p,l,s)
#define WRITE_STREAM(p,l,s) buffer_file_write (p,l,s)
#define GETS_STREAM(p,l,s) buffer_file_gets(p,l,s)
#define GETC_STREAM(s) buffer_file_getc(s)
#define OPEN_STREAM(f,m) buffer_file_open (f,m)
#define REOPEN_STREAM(f,m) buffer_file_dopen (f,m)
#define FIND_STREAM(f)  buffer_file_tell(f)
#define REVERT_STREAM(f,o,s) buffer_file_seek(f,o,s)
#define CLOSE_STREAM(s) buffer_file_close (s)
...
// extern BUFFER_FILE* lastOpenedBufferFile;// = NULL;

size_t buffer_file_read(void* buffer, size_t count, BUFFER_FILE* file);
size_t buffer_file_write(void* buffer, size_t count, BUFFER_FILE* file);
char* buffer_file_gets(char* buffer, int count, BUFFER_FILE* file);
int buffer_file_getc(BUFFER_FILE* file);
BUFFER_FILE* buffer_file_open(const char* filename, const char* mode);
BUFFER_FILE* buffer_file_dopen (int handle, const char* mode);
long buffer_file_tell(BUFFER_FILE* file);
int buffer_file_seek(BUFFER_FILE * file, long offset, int origin);
void buffer_file_close(BUFFER_FILE* file);
