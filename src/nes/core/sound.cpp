...
//		WaveHi[V]+=((RawDALatch<<16))&(~0xFFFF); // TODO get rid of floating calculations to binary. set log volume scaling.
//	ChannelBC[4]=SOUNDTS;
//}
...
//			*start += (tcout)&(~0xFFFF);  // TODO OPTIMIZE ME NOW DAMMIT!
//			start++;
//		}
...
//		{
//			//Modify volume based on channel volume modifiers
//			WaveHi[V]+=(tcout)&(~0xFFFF);  // TODO OPTIMIZE ME!
//			wlcount[2]--;
//			if(!wlcount[2])
//			{
...
nosoundo:
	...
	for(x=0;x<5;x++)
	{
		ChannelBC[x]=0;//end&0xF;
	}
	soundtsoffs = 0;//(soundtsinc*(end&0xF))>>16;
	end>>=4;
